...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gftool-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13553&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gftool-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gftool` can be installed with:

```
conda install gftool
```

It is possible to list all of the versions of `gftool` available on your platform with:
